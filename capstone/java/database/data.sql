...
INSERT INTO orders(id, user_id, orderstatus_id, pickup_date, pickup_time) VALUES
(1, 1, 1, '2025-04-26', '12:00'),
(2, 2, 2, '2025-04-27', '9:00'),
(3, 3, 3, '2025-04-27', '10:00'),
(4, 1, 1, '2025-04-29', '8:00'),
(5, 2, 2, '2025-04-29', '10:00'),
(6, 3, 3, '2025-04-29', '16:00'),
(7, 1, 1, '2025-04-30', '12:00'),
(8, 2, 2, '2025-04-30', '14:00'),
(9, 1, 1, '2025-04-30', '15:00'),
(10, 2, 2, '2025-04-30', '17:00'),
(11, 3, 3, '2025-04-30', '10:00'),
(12, 1, 1, '2025-05-01', '11:00'),
(13, 2, 2, '2025-05-02', '10:00'),
(14, 3, 3, '2025-05-05', '10:00'),
(15, 1, 1, '2025-05-26', '13:00'),
(16, 2, 2, '2025-05-27', '13:00'),
(17, 3, 3, '2025-05-27', '15:00');

-- Insert into orderDetails table
INSERT INTO orderdetails(id, order_id, cake_id, writing, cake_quantity) VALUES
(1, 1, 1, 'happy birthday!', 1),
(2, 2, 2, '', 1),
(3, 3, 3, 'cake writing 2!', 1),
(4, 4, 4, '', 1),
(5, 5, 5, '', 1),
(6, 6, 6, 'cake writing 3!', 1),
(7, 7, 7, '', 1),
(8, 8, 1, '', 1),
(9, 9, 2, '', 1),
(10, 10, 3, 'cake writing 4!', 1),
(11, 11, 4, '', 1),
(12, 12, 5, '', 1),
(13, 13, 6, '', 1),
(14, 14, 7, '', 1),
(15, 15, 1, 'cake writing 5!', 1),
(16, 16, 2, '', 1),
(17, 17, 3, '', 1);
COMMIT TRANSACTION;
